...
mostColor = [r[0] for r in results[:100]]
leastColor = [r[0] for r in results[-100:]][::-1]

# construct the montages for the two sets of images
mostColorMontage = build_montages(mostColor, (128,128), (10,10))
leastColorMontage = build_montages(leastColor, (128,128), (10,10))
