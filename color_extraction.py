...
def plotRGB(sorted_data, ppm_values_str,data_path):
    ...
    ax51.scatter(sorted_data[:,0].astype(float),sorted_data[:,2].astype(float),color='red', marker='o', linestyle='dashed', label='Red')
    ...
    ax52.scatter(sorted_data[:,0].astype(float),sorted_data[:,3].astype(float),color='green', marker='o', linestyle='dashed', label='Green')
    ...
    ax53.scatter(sorted_data[:,0].astype(float),sorted_data[:,4].astype(float),color='blue', marker='o', linestyle='dashed', label='Blue')
    ...
    ax61.scatter(sorted_data[:,0].astype(float),sorted_data[:,8].astype(float),color='red', marker='o', linestyle='dashed', label='Red')
    ...
    ax62.scatter(sorted_data[:,0].astype(float),sorted_data[:,9].astype(float),color='green', marker='o', linestyle='dashed', label='Green')
    ...
    ax63.scatter(sorted_data[:,0].astype(float),sorted_data[:,10].astype(float),color='blue', marker='o', linestyle='dashed', label='Blue')
    ...
    ax71.scatter(sorted_data[:,0].astype(float),sorted_data[:,14].astype(float),color='red', marker='o', linestyle='dashed', label='Red')
    ...
    ax72.scatter(sorted_data[:,0].astype(float),sorted_data[:,15].astype(float),color='green', marker='o', linestyle='dashed', label='Green')
    ...
    ax73.scatter(sorted_data[:,0].astype(float),sorted_data[:,16].astype(float),color='blue', marker='o', linestyle='dashed', label='Blue')
    ...
    ax81_axes.scatter(sorted_data[:,0].astype(float),sorted_data[:,14].astype(float),color='red', marker='o', linestyle='dashed', label='Red')
...
def scatter_plotRGB(sorted_data, ppm_values_str,data_path):
    ...
    #plot the RGB_Mean Intensity of the paper sensor that was taken
    axes_rgb.scatter(sorted_data[:,0].astype(float),sorted_data[:,2].astype(float),color='red', marker='o', linestyle='dashed', label = "Red")
    axes_rgb.scatter(sorted_data[:,0].astype(float),sorted_data[:,3].astype(float),color='green', marker='o', linestyle='dashed', label = 'Green')
    axes_rgb.scatter(sorted_data[:,0].astype(float),sorted_data[:,4].astype(float),color='blue', marker='o', linestyle='dashed', label= 'Blue')
...
def scatter_plotHSV(sorted_data, ppm_values_str,data_path):
    ...
    #plot the RGB_Mean Intensity of the paper sensor that was taken
    axes_hsv.scatter(sorted_data[:,0].astype(float),sorted_data[:,8].astype(float),color='red', marker='o', linestyle='dashed', label = "Hue")
    axes_hsv.scatter(sorted_data[:,0].astype(float),sorted_data[:,9].astype(float),color='green', marker='o', linestyle='dashed', label = 'Saturation')
    axes_hsv.scatter(sorted_data[:,0].astype(float),sorted_data[:,10].astype(float),color='blue', marker='o', linestyle='dashed', label= 'Value')
...
def scatter_plotLAB(sorted_data, ppm_values_str,data_path):
    ...
    #plot the RGB_Mean Intensity of the paper sensor that was taken
    axes_lab.scatter(sorted_data[:,0].astype(float),sorted_data[:,14].astype(float),color='red', marker='o', linestyle='dashed', label = "L")
    axes_lab.scatter(sorted_data[:,0].astype(float),sorted_data[:,15].astype(float),color='green', marker='o', linestyle='dashed', label = 'a*')
    axes_lab.scatter(sorted_data[:,0].astype(float),sorted_data[:,16].astype(float),color='blue', marker='o', linestyle='dashed', label= 'b*')
...
def scatter_plotGRAY(sorted_data, ppm_values_str,data_path):
    ...
    #plot the RGB_Mean Intensity of the paper sensor that was taken
    plt.scatter(sorted_data[:,0].astype(float),sorted_data[:,20].astype(float),color='red', marker='o', linestyle='dashed', label = "Gray")
