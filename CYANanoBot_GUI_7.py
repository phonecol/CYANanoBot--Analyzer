...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(750, 220, 321, 411))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 170, 301, 111))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.ra_lr_checkBox = QtWidgets.QCheckBox(self.verticalLayoutWidget)
        self.ra_lr_checkBox.setObjectName("ra_lr_checkBox")
        self.verticalLayout.addWidget(self.ra_lr_checkBox)
        self.ra_mlr_checkBox = QtWidgets.QCheckBox(self.verticalLayoutWidget)
        self.ra_mlr_checkBox.setObjectName("ra_mlr_checkBox")
        self.verticalLayout.addWidget(self.ra_mlr_checkBox)
        self.ra_pr_checkBox = QtWidgets.QCheckBox(self.verticalLayoutWidget)
        self.ra_pr_checkBox.setObjectName("ra_pr_checkBox")
        self.verticalLayout.addWidget(self.ra_pr_checkBox)
        self.ra_mpr_checkBox = QtWidgets.QCheckBox(self.verticalLayoutWidget)
        self.ra_mpr_checkBox.setObjectName("ra_mpr_checkBox")
        self.verticalLayout.addWidget(self.ra_mpr_checkBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ra_lr_checkBox.setText(_translate("MainWindow", "Linear Regression"))
        self.ra_mlr_checkBox.setText(_translate("MainWindow", "Multiple Linear Regression"))
        self.ra_pr_checkBox.setText(_translate("MainWindow", "Polynomial Regressiion"))
        self.ra_mpr_checkBox.setText(_translate("MainWindow", "Multiple Polynomial Regression"))
    ...
    # def ra_lr_checked(self):
 


    # def ra_mlr_checked(self):

    # def ra_pr_checked(self):

    # def ra_mpr_checked(self):
