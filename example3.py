...
def save_data(data):
    ...
    print("data",data)
    sorted_data = natsorted(data,key=itemgetter(0))
    print("data",sorted_data)

    header = 'Cyanide Concentration,R,G,B,R_std,G_std,B_std,H,S,V,H_std,S_std,V_std,L,a,b,L_std,a_std,b_std,Gray,Gray_std' #initialize the header for the csv file
    filename_Data ="ColorData/"+image_number+ "_ColorData_" + timestr+".csv" 
    filename_Sorted_Data ="ColorData/"+image_number+ "_ColorSortedData_" + timestr+".csv" 
    data = np.array(data)
...
data = np.vstack((cn_Concentrations,RGB_Means_str,RGB_stds_str,HSV_Means_str,HSV_stds_str,Lab_Means_str,Lab_stds_str,Gray_Means_str, Gray_stds_str))
...
# #plot the RGB_Mean Intensity of the paper sensor that was taken
# ax1.plot(sorted_data[:,0],sorted_data[:,1],color='red', marker='o', linestyle='dashed')
# ax1.plot(sorted_data[:,0],sorted_data[:,2],color='green', marker='o', linestyle='dashed')
# ax1.plot(sorted_data[:,0],sorted_data[:,3],color='blue', marker='o', linestyle='dashed')
# ax1.set_ylabel('Mean Pixel Intensity')
# ax1.set_xlabel('Cyanide Concentration')
# ax1.set_title("Mean Pixel Intensity of Au-NP's in RGB Colorspace")
# ax1.legend()
...
# fig2, (ax21, ax22) = plt.subplots(2, 1)
# ax21.plot(sorted_data[:,0],sorted_data[:,7],color='red', marker='o', linestyle='dashed', label='Hue')
# ax21.plot(sorted_data[:,0],sorted_data[:,8],color='green', marker='o', linestyle='dashed', label='Saturation')
# ax21.plot(sorted_data[:,0],sorted_data[:,9],color='blue', marker='o', linestyle='dashed', label='Value')
# ax21.set_ylabel('Mean Pixel Intensity')
# ax21.set_xlabel('Cyanide Concentration(PPM)')
# ax21.set_title("Mean Pixel Intensity of Au-NP's in HSV Colorspace")
# ax21.legend()
...
# fig3, (ax31, ax32) = plt.subplots(2, 1)
# ax31.plot(sorted_data[:,0],sorted_data[:,13],color='red', marker='o', linestyle='dashed', label='L')
# ax31.plot(sorted_data[:,0],sorted_data[:,14],color='green', marker='o', linestyle='dashed', label='a')
# ax31.plot(sorted_data[:,0],sorted_data[:,15],color='blue', marker='o', linestyle='dashed', label='b')
# ax31.set_ylabel('Mean Pixel Intensity')
# ax31.set_xlabel('Cyanide Concentration(PPM)')
# ax31.set_title("Mean Pixel Intensity of Au-NP's in LAB Colorspace")
# ax31.legend()
...
# # plt.show()
# fig4, (ax41, ax42) = plt.subplots(2, 1)
# ax41.plot(sorted_data[:,0],sorted_data[:,19],color='red', marker='o', linestyle='dashed', label='Gray')
# ax41.set_ylabel('Mean Pixel Intensity')
# ax41.set_xlabel('CYANIDE Concentration (PPM)')
# ax41.set_title("Mean Pixel Intensity of Au-NP's in Gray Colorspace")
